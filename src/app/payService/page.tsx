            ...
            <>
                <div className='w-[1000px] mx-auto flex items-center justify-between py-[50px]'>
                    <div className=''>
                        ...
                        <div className='text-btn-and-title text-[16px] font-medium mb-[10px]'>Номер карты</div>
