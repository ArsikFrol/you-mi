...
export default function AnyOtherQuestions() {
    return (
        <div className="my-[100px]">
            ...
            <div className='cursor-pointer rounded-2xl border border-(--color-btn-and-title) w-[360px] text-center mx-auto leading-[70px] h-[70px] text-(--color-btn-and-title) text-[20px] font-bold'>@youmipsy</div>
        </div>
    )
}