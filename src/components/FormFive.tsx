        ...
        <div className='w-[580px] mx-auto text'>
                            ...
                            return (
                                <div className='flex justify-between w-[400px] items-center ' key={index}>
                                    ...
                                    <div className='flex gap-x-[10px] items-center'>
                                        ...
                                        <div className='text-btn-and-title text-[18px] font-medium'>₽</div>
                                    </div>
                                </div>
                            )
                        })
            ...
            <div className='mb-[30px]'>
                ...
                <div className='flex gap-x-[20px]'>
                    <div style={{
                        ...
                        border-btn-and-title text-btn-and-title rounded-2xl'>Да</div>
                    <div style={{
                        ...
                        className='cursor-pointer hover:scale-105 transition-transform duration-300
                            w-[90px] text-center h-[50px] leading-[50px] border-2
                        border-btn-and-title text-btn-and-title rounded-2xl'>Нет</div>
                </div>
            </div>
            <div className='mb-[30px]'>
            ...
            <div className=''>
                ...
                <textarea value={tellUsAboutYourself} onChange={(e) => setTellUsAboutYourself(e.target.value)}
                    className="w-[580px] h-[120px] border-2 rounded-2xl border-btn-and-title
