                ...
                <div className='flex gap-x-[20px]'>
                    <div style={{
                        ...
                        className='cursor-pointer hover:scale-105 transition-transform duration-300 
                            w-[90px] text-center h-[50px] leading-[50px] border-2 border-(--color-btn-and-title) rounded-2xl'>Да</div>
                    <div style={{
                        ...(doYouHaveExperienceWorking == 'нет' ? { background: 'rgba(120, 114, 185, 1)', color: 'white' } : {})
                    }} onClick={() => { setDoYouHaveExperienceWorking('нет') }}
                        className='cursor-pointer hover:scale-105 transition-transform duration-300 
                            w-[90px] text-center h-[50px] leading-[50px] border-2 border-(--color-btn-and-title) rounded-2xl'>Нет</div>
                </div>
            </div>
            ...
            <div className='mb-[30px]'>
                ...
                <div className='flex gap-x-[20px] w-[700px]'>
                    ...
                    <div style={{
                        ...
                        className='cursor-pointer hover:scale-105 transition-transform duration-300 
                            w-[210px] text-center h-[50px] leading-[50px] border-2 border-(--color-btn-and-title) rounded-2xl'>
                        Планирую начать
                    </div>
                    <div style={{
                        ...
                        className='cursor-pointer hover:scale-105 transition-transform duration-300 
                            w-[300px] text-center h-[50px] leading-[50px] border-2 border-(--color-btn-and-title) rounded-2xl'>
                        Не проходил и не планирую
                    </div>
                </div>
            </div>
            {areYouPersonalTherapy == 'да' &&
                <div className="border-l boder-(--color-btn-and-title) pl-[20px] ml-[50px]">
                    <div className='mb-[30px]'>
