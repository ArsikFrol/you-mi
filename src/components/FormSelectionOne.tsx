    ...
    return (
        <div className='w-[580px] mx-auto'>
                        ...
                        return (
                            <div className="select-none hover:scale-102 transition-transform duration-300 flex gap-x-[10px]
                                ...
                                <div className="relative">
                                    <input className=" w-[22px] h-[22px]  border-btn-and-title border-2
            ...
            <div className='mb-[30px]'>
                ...
                <div className='w-[300px] border-2 border-btn-and-title rounded-2xl flex justify-between'>
                    <div style={{
                        ...(genderPsychologist === 'жен' ? { borderRadius: '12px', background: 'rgba(120, 114, 185, 1)', color: 'white' } : {})
                    }}
                        onClick={() => setGenderPsychologist('жен')}
                        className='text-center text-btn-and-title cursor-pointer h-[50px] leading-[50px] w-[90px]'>Жен</div>
                    <div style={{
                        ...(genderPsychologist === 'муж' ? { borderRadius: '12px', background: 'rgba(120, 114, 185, 1)', color: 'white' } : {})
                    }}
                        onClick={() => setGenderPsychologist('муж')}
                        className='text-center text-btn-and-title cursor-pointer h-[50px] leading-[50px] w-[90px]'>Муж</div>
                    <div style={{
                        ...
                        className='text-center text-btn-and-title cursor-pointer h-[50px] leading-[50px] w-[120px]'>Не важно</div>
                </div>
            </div>
            <div className='mb-[30px]'>
                ...
                <div onClick={clickAge}
                    ...
                    className='hover:scale-105 transition-transform duration-300 cursor-pointer w-[140px] text-center h-[50px] leading-[50px] text-btn-and-title
                        text-[16px] rounded-2xl border-2 border-btn-and-title'>Не важно</div>
            </div>
            <div className='mb-[30px]'>
                ...
                <div className='flex justify-between mb-[30px] w-[200px]'>
                    <div style={{
                        ...
                        className='w-[90px] cursor-pointer h-[50px] hover:scale-105 transition-transform duration-300
                                ...
                                border-btn-and-title rounded-2xl'>Да</div>
                    <div style={{
                        ...
                        className='w-[90px] cursor-pointer h-[50px] hover:scale-105 transition-transform duration-300
                                leading-[50px] text-center border-2
                                border-btn-and-title rounded-2xl'>Нет</div>
                </div>
            </div>
            <div className=''>
