                ...
                <div className='flex justify-between mb-[30px]'>
                    <div style={{
                        ...
                        className='w-[90px] cursor-pointer h-[50px] hover:scale-105 transition-transform
                            ...
                            border-btn-and-title rounded-2xl text-[18px]'>Да</div>
                    <div style={{
                        ...
                        className='w-[90px] cursor-pointer h-[50px] hover:scale-105 transition-transform
                            duration-300 leading-[50px] text-center border-2
                            border-btn-and-title rounded-2xl text-[18px]'>Нет</div>
                    <div style={{
                        ...
                        className='w-[360px] cursor-pointer h-[50px] hover:scale-105 transition-transform
                            duration-300 leading-[50px] text-center border-2
                            border-btn-and-title rounded-2xl text-[16px]'>Нахожусь в процессе получения ВО</div>
                </div>
            </div>
