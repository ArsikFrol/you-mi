        ...
        <div className=''>
            <div className=''>
                ...
                <div className='mb-[20px]'>
                    <div className='text-(--color-btn-and-title) text-[16px] font-medium mb-[10px]'>Имя</div>
                ...
                <div className='mb-[20px]'>
                    <div className='text-(--color-btn-and-title) text-[16px] font-medium mb-[10px]'>Фамилия</div>
                ...
                <div className='mb-[20px]'>
                    <div className='text-(--color-btn-and-title) text-[16px] font-medium mb-[10px]'>Электронная почта</div>
            ...
            <div className='text-(--color-btn-and-title) text-[20px] mb-[40px] font-medium
            ...
            <div className=''>
                <div className="select-none hover:scale-102 transition-transform duration-300 flex gap-x-[30px] 
                    ...
                    <label className='cursor-pointer text-(--text) text-[16px] w-[580px]' htmlFor='agree'>
                        ...
                        с <span className="text-(--color-btn-and-title)">Политикой защиты персональных данных</span>
                    </label>
                </div>
            </div>
